...
import com.ccproject.utils.MidnightApplicationRefresh;



@SpringBootApplication
public class LibraryManagementSystemV2Application {

	public static void main(String[] args) {
		SpringApplication.run(LibraryManagementSystemV2Application.class, args);
	}
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("group14", pwEncoder.encode("test"), "shashank@gmail.com", "Shashank", "Sai", "Newbern", "06-112045", "Kansas City");
			user1.setRole("ROLE_ADMIN");
			
			User user2 = new User("employee", pwEncoder.encode("test"), "employee.com", "employee", "1", "Locarno", "06-87054875", "Kansas City");
			user2.setRole("ROLE_EMPLOYEE");
			
			User user3 = new User("user", pwEncoder.encode("test"), "user@gmail.com", "User", "1", "Troost", "06-18756892", "Kansas City");
			user3.setRole("ROLE_USER");	
			User user4 = new User("Rahul", pwEncoder.encode("test"), "rahul@gmail.com", "Rahul", "kumar", "Troost 173", "06-83472443", "Colorado");
			User user5 = new User("Karthik", pwEncoder.encode("test"), "karthik@gmail.com", "karthil", "Vamshi", "Paseo 90", "06-13644621", "Texas");
